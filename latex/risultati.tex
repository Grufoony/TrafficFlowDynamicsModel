...
Ci si aspetta che il sistema si carichi adiabaticamente, quindi che in uno stato stazionario i diagrammi fondamentali siano del tipo rappresentato in Fig. \ref{figure:greenshield}.
\begin{figure}[H]
...
\end{figure}
Come osservabile in Fig. \ref{fig:FMD_adiabatic_homo} l'ipotesi \`e ben verificata.
...
\begin{figure}[H]
    ...
    mark size=0.69,
    draw=black,
    only marks] file {./temp_data/1800_u-q.dat};
    \end{axis}
    \end{tikzpicture}\hfill
    \begin{tikzpicture}[scale=0.6]
        \begin{axis}[
        ...
        mark size=0.69,
        draw=black,
        only marks] file {./temp_data/1800_q-k.dat};
        \end{axis}
    \end{tikzpicture}
    \centering
    \begin{tikzpicture}[scale=0.6]
    ...
    mark size=0.69,
    draw=black,
    only marks] file {./temp_data/1800_u-k.dat};
    \end{axis}
    \end{tikzpicture}
