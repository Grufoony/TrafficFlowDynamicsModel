...
\begin{frame}
	...
	\begin{figure}[H]
		\begin{tikzpicture}[scale=0.63]
			...
			mark size=0.69,
			draw=green,
			mark=o] file {./data/peaked_homo/q-t_load.dat};
			\addplot[
			mark size=0.69,
			draw=red,
			mark=o] file {./data/peaked_homo/q-t_unload.dat};
			\addplot[
			mark size=0.69,
			draw=green,
			mark=o] file {./data/peaked_homo/q-t_unload2.dat};
			\end{axis}
			\end{tikzpicture}
		\begin{tikzpicture}[scale=0.63]
			\begin{axis}[
			...
			mark size=0.69,
			draw=green,
			mark=o] file {./data/peaked_homo/q-k_load.dat};
			\addplot[
			mark size=0.69,
			draw=red,
			mark=o] file {./data/peaked_homo/q-k_unload.dat};
			\addplot[
			mark size=0.69,
			draw=green,
			mark=o] file {./data/peaked_homo/q-k_unload2.dat};
			\end{axis}
		\end{tikzpicture}
