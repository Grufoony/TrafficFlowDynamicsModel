...
\begin{frame}
	...
	Diminuzione della qualit\`a del trasporto del network che avviene quando uno o pi\`u nodi sono attraversati da pi\`u \emph{entit\`a} di quante ne possano sostenere.

	Nel caso di un sistema di traffico gli effetti tipici delle congestioni comportano la diminuzione della velocit\`a, l'aumento dei tempi di percorrenza e la formazione di code.
	% \begin{figure}
...
\begin{frame}
	...
	\begin{itemize}
		\item velocit\`a assegnata nell'immissione sulla strada
			\begin{equation*}
		...
		\item ad  ogni ciclo di evoluzione la velocit\`a viene riassegnata in base alla densit\`a di veicoli istantanea della strada
	\end{itemize}
...
\begin{frame}
	...
	Confronto tra distribuzioni in regimi differenti.
	\begin{figure}[H]
