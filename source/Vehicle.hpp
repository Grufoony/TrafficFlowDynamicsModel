...
public:
  ...
  static void addVehicleType(const char *); //!< add many vehicle types in
                                            //!< _vehicleType from file
  static std::shared_ptr<VehicleType>
  getVehicleType(int const);    //!< get a vehicle
                                //!< type from
                                //!< _vehicleType
  static int getNVehicleType(); //!< get the number of vehicle types in
                                //!< _vehicleType
